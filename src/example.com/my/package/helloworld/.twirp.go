...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(pathPrefix, "example.com.my.package.helloworld", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "example.com.my.package.helloworld")
...
const HelloWorldPathPrefix = "/twirp/example.com.my.package.helloworld.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "example.com.my.package.helloworld.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "example.com.my.package.helloworld", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x62, 0xd3, 0x2b, 0x28, 0xca,
	0x2f, 0xc9, 0x17, 0x52, 0x4c, 0xad, 0x48, 0xcc, 0x2d, 0xc8, 0x49, 0xd5, 0x4b, 0xce, 0xcf, 0xd5,
	0xcb, 0xad, 0xd4, 0x2b, 0x48, 0x4c, 0xce, 0x4e, 0x4c, 0x4f, 0xd5, 0xcb, 0x48, 0xcd, 0xc9, 0xc9,
	0x2f, 0xcf, 0x2f, 0xca, 0x49, 0x51, 0x52, 0xe1, 0xe2, 0xf0, 0x00, 0xf1, 0x82, 0x52, 0x0b, 0x85,
	...
	0xd4, 0x0a, 0x98, 0x1a, 0x30, 0xdb, 0xa8, 0x80, 0x8b, 0x0b, 0xac, 0x20, 0x1c, 0x64, 0xa8, 0x50,
	0x12, 0x17, 0x2b, 0x98, 0x27, 0xa4, 0xad, 0x47, 0xd0, 0x05, 0x7a, 0x30, 0xeb, 0xa5, 0x74, 0x88,
	0x57, 0x5c, 0x5c, 0xe0, 0xa4, 0x1c, 0x85, 0xec, 0x3b, 0xfd, 0xdc, 0x4a, 0x7d, 0xa8, 0x72, 0x7d,
	0x84, 0xf2, 0x24, 0x36, 0x70, 0x38, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x14, 0x2f, 0xa9,
	0xb3, 0x11, 0x01, 0x00, 0x00,
}
